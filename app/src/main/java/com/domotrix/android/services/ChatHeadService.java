...
public class ChatHeadService extends Service {
  private final String TAG = "ChatHeadService";
	...
	private void handleStart(){
		...
		removeView = (RelativeLayout)inflater.inflate(R.layout.chathead_remove, null);
		...
		txtView = (LinearLayout)inflater.inflate(R.layout.chathead_txt, null);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if(intent != null){
			...
			if(bd != null)
				sMsg = bd.getString("EXTRA_MESSAGE");
